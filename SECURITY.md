...
If you believe you have discovered a vulnerability in our product or have a security incident to report, use the "Report a vulnerability" feature from the [security advisories](https://github.com/majorahq/security/security/advisories) section of this repository.  
